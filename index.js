...
http.createServer(function (req, res) {
    ...
    function urldatabasic(filetype, slug) {
        if (slug == undefined) {
            slug = "";
        }
    ...
    function urlex(filetypeex, slugex) {
        urldatabasic(filetypeex, slugex);
    }
	...
	//function urlpredata() {
	//	console.log("here it is "+pathdataarray["1"]);
	//	if (pathdataarray["1"] == "/pre") {
	//		console.log("---------------------------------------------------------------------------------------------------");
	//		urldatabasic("html", urlslug.substr(3, urlslug.length-4), true);
	//	}
	//}
}).listen(3000);
/*
